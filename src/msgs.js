...
4️⃣ Профиль журналиста — «медицина», «главный редактор».

📌 <b>Работа с контактами:</b>

<b>Добавить нового журналиста:</b>
Выбери кнопку <i>Добавить новый контакт</i>, и я подскажу, какие данные ввести.
...
Выбери кнопку <i>Отправить сообщение админу</i>, чтобы попросить удалить неактуальные данные.

📢 Нужна помощь?
В любой непонятной ситуации пиши админу ☕️`
